...
intro <- tryCatch(
    {
        description <- packageDescription("MyBiocBook")
...
👉 [ghcr.io/lgatto/mybiocbook](https://ghcr.io/lgatto/mybiocbook) 🐳
...
#| eval: false
docker run -it ghcr.io/lgatto/mybiocbook:devel R
```
...
docker run \
    ...
    -e PASSWORD=OHCA \
    -p 8787:8787 \
    ghcr.io/lgatto/mybiocbook:devel
```
...
#| eval: false
docker run -it ghcr.io/lgatto/mybiocbook:devel bash
